...
var nginx_sardine_1 = require("./nginx.sardine");
exports.NginxProtocol = nginx_sardine_1.NginxProtocol;
...
exports.config = function (configData) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!sardines_core_1.Core.isRemote('sardines-built-in-services', '/gateway/nginx', 'config')) return [3, 2];
            ...
            case 2: return [4, origin.config(configData)];
