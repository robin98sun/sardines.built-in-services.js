...
var fs = require("fs");
var NginxProtocol;
(function (NginxProtocol) {
    NginxProtocol["HTTP"] = "HTTP";
    NginxProtocol["HTTPS"] = "HTTPS";
})(NginxProtocol = exports.NginxProtocol || (exports.NginxProtocol = {}));
var defaultNginxConfig = {
...
var nginxConfig = defaultNginxConfig;
exports.echo = function (msg) {
    return msg;
};
exports.config = function (configData) { return __awaiter(void 0, void 0, void 0, function () {
    var configuration;
    return __generator(this, function (_a) {
        configuration = Object.assign({}, defaultNginxConfig, configData);
        if (configuration) {
