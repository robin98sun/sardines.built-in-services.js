...
exports.setup = function (nginxConfig, nginxConfigFilePath, nginxConfigDir, sslCrt, sslKey) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    proxy = new nginx_reverse_proxy_1.NginxReverseProxy(nginxConfig, nginxConfigFilePath, nginxConfigDir, sslCrt, sslKey);
...
exports.test = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2, "current dir: " + proc.cwd() + ", key dir: " + path.resolve(proc.cwd(), './keys')];
    });
}); };
