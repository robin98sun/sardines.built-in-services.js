...
exports.setup = function (nginxConfig, nginxConfigFilePath, nginxConfigDir, sslCrt, sslKey) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2: return [4, origin.setup(nginxConfig, nginxConfigFilePath, nginxConfigDir, sslCrt, sslKey)];
...
exports.test = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!sardines_core_1.Core.isRemote('sardines-built-in-services', '/access_point/nginx', 'test')) return [3, 2];
                return [4, sardines_core_1.Core.invoke({
                        identity: {
                            application: 'sardines-built-in-services',
                            module: '/access_point/nginx',
