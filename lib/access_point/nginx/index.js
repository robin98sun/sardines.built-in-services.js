        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3, 4];
                case 4:
                    console.log('DEBUG: nginx proxy setup, input parameter', 'nginxConfig', sardines_core_1.utils.inspect(nginxConfig));
                    console.log('DEBUG: nginx proxy setup, input parameter', 'sslCrtLines', sardines_core_1.utils.inspect(sslCrtLines));
                    console.log('DEBUG: nginx proxy setup, input parameter', 'sslKeyLines', sardines_core_1.utils.inspect(sslKeyLines));
                    return [2, {
                            res: res,
                            key: proxy.sslKey,
                            crt: proxy.sslCrt,
