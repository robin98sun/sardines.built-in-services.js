...
var generateNginxConfigFile = function (configFilePath, configSettings) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var config, content;
        return __generator(this, function (_a) {
            config = Object.assign({}, configSettings, exports.defaultNginxConfig);
...
var NginxReverseProxy = (function () {
    function NginxReverseProxy(ipaddr, port, auth, nginxConfigFilePath, nginxConfigDir, nginxConfigSettings) {
        ...
        this.port = port;
        this.auth = auth;
        this.nginxConfig = Object.assign({}, nginxConfigSettings, exports.defaultNginxConfig);
    }
    ...
    NginxReverseProxy.prototype.start = function () {
        return __awaiter(this, void 0, void 0, function () {
            var nginxRuntime, restartResult, newConfigFileContent;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4, generateNginxConfigFile(this.nginxConfigFilePath, this.nginxConfig)];
                    case 4:
                        _a.sent();
                        return [4, execCmd("/use/sbin/service nginx restart")];
                    case 5:
                        restartResult = _a.sent();
                        return [4, fs.readFileSync(this.nginxConfigFilePath, { encoding: 'utf8' })];
                    case 6:
                        newConfigFileContent = _a.sent();
                        return [2, { nginxConfigFile: newConfigFileContent, serviceRestartResult: restartResult }];
                }
            });
        });
    };
